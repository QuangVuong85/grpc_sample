...
func RegisterServiceBHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ServiceBServer) error {
	...
	mux.Handle("GET", pattern_ServiceB_Ping_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_ServiceB_Ping_0(rctx, inboundMarshaler, server, req, pathParams)
...
var (
	pattern_ServiceB_Ping_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"core", "serviceB", "ping", "timestamp"}, "", runtime.AssumeColonVerbOpt(true)))
)
